...
const CreditorsForm = (props: any) => {
  ...
  return (
    <Spin spinning={isLoading} tip='Loading...'>
      <div className='creditors-title'>
        <h1>Creditors information</h1>
      </div>
      <Form className='creditors-form' form={form} onFinish={onfinish}>
        <Form.Item name='creditor1'>
          <div className='creditors-fields'>
            ...
            <Form.Item rules={[{ required: true, message: 'Field required' }]}>
              <Upload
                maxCount={1}
                name='upload'
