...
id:props.values.id
        ...
        console.log((fileList.id!=="" || fileList.id!==null) && (fileList.FileList.length))
...
setFileList({id:null,FileList:[]})
  ...
  <Spin spinning={isLoading} tip="Loading...">
    <div className="company-form-container"><h1>Company information</h1></div>
    <Form  className='company-form' form={form} onFinish={onfinish}>
        ...
        <Form.Item label="Company Address" name="address" rules={[{required:true,message : "Company address is required"}]}>
            <Input/>
        </Form.Item>
        <Form.Item label="Phone No" name="phoneno" rules={[{required:true,message : "Phone No  is required"}]}>
            <Input/>
        </Form.Item>
        ...
        <Form.Item label="Trade License No/CIN" name="trade_no" rules={[{required:true,message : "Company name is required"}]} 
        >
            <Input/>
        </Form.Item>
           <Form.Item label="Trade license/Certificate of Incorporation" rules={[{required:true,message:"Trade certificate is required"
        }]}
        className="company-info-upload"
        name="company_info"
        >
           <Upload maxCount={1} name="upload"
        ...
        <Button htmlType='submit' type='primary' size='large'>Proceed</Button>
        </div>
    </Form>
    </Spin>
    </>
