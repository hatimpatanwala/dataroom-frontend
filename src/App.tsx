...
function App(props: any) {
  ...
  //   message.success('inside test post req')
  //   await axios
  //     .post(`${process.env.REACT_APP_SERVER_URL}/api/V1/admin/testpostreq`, {
  //       id: '1231313',
  //     })
  //     .then((res) => {
  //       console.log(res)
  //       if (res.status === 200) {
  //         message.success('received post req')
  //       }
  //     })
  //     .catch((err) => {
  //       message.error(err)
  //       message.error('error while receiving ')
  //     })
  // }
  // const testReq = async () => {
  //   await axios
  ...
  //     .then((res) => {
  //       console.log(res)
  //       message.success('got all result')
  //     })
  //     .catch((err) => {
  //       console.log(err)
  //       message.error('error in all requestt')
  //       // setIsLoading(false)
  //     })
  // const response = await fetch(
  //   `${process.env.REACT_APP_SERVER_URL}/api/V1/admin/testreq`
  // )
  //   .then((data) => {
  //     return data.json()
  //   })
  //   .then((post) => {
  //     message.warning(post.status)
  //     // console.log(post.title)
  //     message.success(post)
  //   })
  // await axios
  //   .get(`${process.env.REACT_APP_SERVER_URL}/api/V1/admin/testreq`, {
  //     headers: {
  ...
  useEffect(() => {
    ...
    if (user) {
      ...
      axios
        .post(
          `${process.env.REACT_APP_SERVER_URL}/api/V1/admin/login`,
          {},
          {
            headers: {
                  ...
                  <Content>
                    <div className='breadcrumb'>
                      ...
                      <img
                        height={20}
                        width={20}
                        src={process.env.PUBLIC_URL + 'assets/icons/info.jpg'}
                        onClick={infoPanelIcon ? rightSiderVisible : () => {}}
                    ...
                    >
                      <div>
                        <Routes>
                          {primaryRoutes.map((tools, index) => {
                            const Component = tools.component
                            return (
                              <Route
                                path={tools.link}
                                key={index}
                                element={<Component userInfo={userInfo} />}
                              />
                            )
                          })}
                          <Route
